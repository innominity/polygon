...
class RemoteAppSoftwareTask:
    ...
    def __init__(self, remote_app_guid: str=None, remote_app_task_guid: str=None, guid_config_files: list[str]=None):
        ...
        if remote_app_guid is None and remote_app_task_guid is None:
            raise Exception("Должен быть передан либо GUID приложения либо GUID задачи выполнения приложения")

        self.__remote_app_guid = remote_app_guid
        self.__task_guid = self.__create_app_task(remote_app_guid) if remote_app_task_guid is None else remote_app_task_guid
